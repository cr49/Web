        ...
        <table class="table">
            <thead>
                <tr>
                    ...
                    <th scope="col">AMOUNT FROM USER</th>
                    <th scope="col">AMOUNT FROM STORE</th>
                    <th scope="col">AMOUNT TO STORE</th>
                    <th scope="col">AMOUNT TO GD</th>
            ...
            <tbody class="table-border-bottom-0">
                <c:forEach items="${listD}" var="o">
                    <tr>
            			...
            			<td>${o.phone}</td>
            			<td>${o.status}</td>
                        <td>${o.ispaidbefore}</td>
						<td>${o.amountfromuser}</td>
						<td>${o.amountfromstore}</td>
						<td>${o.amounttostore}</td>
						<td>${o.amounttogd}</td>
						<td>${o.create}</td>
						<td>
                           	<a class="dropdown-item" href="<c:url value="/DeleteDonhangControl?did=${o.id}"/>">
                            	<i class="bx bx-edit-alt me-1"></i> 
                            	Xóa
                           	</a>
                           	<a class="dropdown-item" href="<c:url value="/LoadDonhangControl?did=${o.id}"/>">
                            	<i class="bx bx-edit-alt me-1"></i> 
                            	Sửa
                           	</a>
                        </td>
    ...
    <div id="addEmployeeModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="AddDonhangControl" method="post">
                        ...
                        <div class="modal-body">					
                            ...
                            <div class="form-group">
                                ...
                                <input name="deliveryid" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input name="paidbefore" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Amount From User</label>
                                <input name="afuser" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Amount From Store</label>
                                <input name="afstore" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Amount To Store</label>
                                <input name="atstore" type="text" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Amount To GD</label>
                                <input name="atgd" type="text" class="form-control" required>
                            </div>
                        </div>
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true" data-img="theme-assets/images/backgrounds/02.jpg">
      ...
      <div class="main-menu-content">
        ...
        <li style="margin-bottom: 50px;
          ...
          <li class=" active"><a href="<c:url value="/QLDonhangControl"/>"><i class="ft-circle"></i><span class="menu-title" data-i18n="">Quản lý đơn hàng</span></a>
          </li>
