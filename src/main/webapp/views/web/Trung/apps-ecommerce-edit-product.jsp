    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <form action="edit?id=${product._id}" method="post" id="createproduct-form" autocomplete="off" class="needs-validation" novalidate>
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-body">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="choices-publish-status-input"
                                            ...
                                            <c:if test="${product.selling == true}">
                                                <option value="Published" selected>Published</option>
                                                <option value="Draft">Draft</option>

                                            </c:if>
                                            <c:if test="${product.selling == false}">
                                                <option value="Published">Published</option>
                                                <option value="Draft" selected>Draft</option>
                                            </c:if>
<%--                                            <option value="Published" selected>Published</option>--%>
<%--                                            &lt;%&ndash;                                            <option value="Scheduled">Scheduled</option>&ndash;%&gt;--%>
<%--                                            <option value="Draft">Draft</option>--%>
                                        </select>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <select class="form-select" id="choices-category-input"
                                        ...
                                        <c:forEach items="${categories}" var="category">
                                            <c:if test="${product.categoryId == category._id}">
