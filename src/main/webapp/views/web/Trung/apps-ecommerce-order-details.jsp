...
<!-- Mirrored from themesbrand.com/velzon/html/default/apps-ecommerce-order-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Dec 2022 12:41:58 GMT -->
<head>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive table-card">
                  <table class="table table-nowrap align-middle table-borderless mb-0">
                    ...
                    <tbody>
                    <c:forEach items="${productListOrderTrungList}" var="o">
                    <tr>
                      <td>
                        <div class="d-flex">
                          <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                            <img src="${o.img}" alt="" class="img-fluid d-block">
                          </div>
                          <div class="flex-grow-1 ms-3">
                            <h5 class="fs-15"><a href="apps-ecommerce-product-details.html" class="link-primary">${o.name}</a></h5>
                            <p class="text-muted mb-0">Color: <span class="fw-medium">Pink</span></p>
                            <p class="text-muted mb-0">Size: <span class="fw-medium">${o.size}</span></p>
                          </div>
                        </div>
                      </td>
                      <td>${o.price}</td>
...
<%--                          </tr>--%>
                          <tr>
                            ...
                            <td class="text-end">${deliveryEntity}</td>
                          </tr>
                          <tr>
                            <td>Tax Charge :</td>
                          ...
                          <tr class="border-top border-top-dashed">
                            ...
                            <th class="text-end">${orderEntity.amountFromUser}</th>
                          </tr>
                          </tbody>
                        </table>
                      </td>
                ...
                <ul class="list-unstyled mb-0 vstack gap-3">
                  <li>
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="fs-14 mb-1">${userEntity.firstname} ${userEntity.lastname}</h6>
                        <p class="text-muted mb-0">Customer</p>
                      </div>
                    </div>
                  </li>
                  <li><i class="ri-mail-line me-2 align-middle text-muted fs-16"></i>${userEntity.email}</li>
                  <li><i class="ri-phone-line me-2 align-middle text-muted fs-16"></i>+ ${userEntity.phone}</li>
                </ul>
              </div>
            </div>
            <!--end card-->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <ul class="list-unstyled vstack gap-2 fs-13 mb-0">
                  <li class="fw-medium fs-14">${address}</li>
<%--                  <li>${orderEntity.address}</li>--%>
...
<%--                  <li>United States</li>--%>
            ...
            <!--end card-->
              <div class="card">
                  <div class="card-header">
                      <h5 class="card-title mb-0"><i class="ri-map-pin-line align-middle me-1 text-muted"></i>Status Delivery</h5>
                  </div>
                  <div class="card-body">
                      <ul class="list-unstyled vstack gap-2 fs-13 mb-0">
                          <li class="fw-medium fs-14">${status}</li>
                          <li><a style="color: #8fdf82" href="/Final_Project/vendor/orders?idUpdateS=${idOrder}">Edit status</a></li>
                          <%--                  <li>${orderEntity.address}</li>--%>
                          <%--                  <li>2186 Joyce Street Rocky Mount</li>--%>
                          <%--                  <li>California - 24567</li>--%>
                          <%--                  <li>United States</li>--%>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/apps-ecommerce-order-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Dec 2022 12:41:59 GMT -->
</html>