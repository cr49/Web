...
<!-- Mirrored from themesbrand.com/velzon/html/default/apps-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Dec 2022 12:41:36 GMT -->
...
<%--                        <!-- end card -->--%>
<%--                    </div>--%>
                    <!-- end col class="col-xl-9 col-lg-8" -->
                                            ...
                                            <div class="col-sm-auto">
                                                <div>
                                                    <button type="button" class="btn btn-success add-btn"
                                                        ...
                                                        <a href="/Final_Project/vendor/products/new">Add New</a>
                                                    </button>
                                            ...
                                            <div class="col-sm">
                                                <div class="d-flex justify-content-sm-end">
                                                    <div class="search-box ms-2">
                                                        <form action="/Final_Project/vendor/products/search?search=${search}">
...
<%--                                                        </div>--%>
<%--                                                    </th>--%>
                                                    <th class="sort" data-sort="customer_name">Product</th>
                                                    <th class="sort" data-sort="product_img">Image</th>
                                                    <th class="sort" data-sort="email">Stock</th>
                                                    <th class="sort" data-sort="phone">Price</th>
                                                    <th class="sort" data-sort="date">Rating</th>
...
<%--                                                    </th>--%>
                                                    ...
                                                    <td class="customer_name"><a href="products?id_Product=${o._id}">${o.name}</a></td>
                                                    <% String img = "${o.Url_image}"; %>
                                                    <td class="product_img">
                                                        <img width="70px" height="70px" src="${o.url_image}" alt="This is photo">
                                                    </td>
                                                    <td class="email">${o.stock}</td>
                                                    <td class="phone">${o.price}</td>
                                                    <td class="date">${o.rating}</td>
                                                    <td class="status">${o.selling}</td>
                                                    <td>
                                                        <div class="d-flex gap-2">
                                                            <div class="edit">
                                                                <button
                                                                    ...
                                                                    <a href="/Final_Project/vendor/products/edit?id=${o._id}">Edit</a>
                                                                </button>
                                                            </div>
                                                            <div class="remove">
                                                                <button
                                                                    ...
                                                                    <a href="/Final_Project/vendor/products/delete?id=${o._id}">Remove</a>
                                                                </button>
                                                            </div>
                                                        </div>
                                                    </td>
...
<%--                                                <li class="page-item active"><a href="stores-list?page=1"--%>
...
<!-- nouisliderribute js -->
<script src="<c:url value="/template/Trung/assets/libs/nouislider/nouislider.min.js"/>"></script>
<script src="<c:url value="/template/Trung/assets/libs/wnumb/wNumb.min.js"/>"></script>

<!-- gridjs js -->
<script src="<c:url value="/template/Trung/assets/libs/gridjs/gridjs.umd.js"/>"></script>
<script src="<c:url value="/template/Trung/unpkg.com/gridjs%405.1.0/plugins/selection/dist/selection.umd.js"/>"></script>
<!-- ecommerce product list -->
<script src="<c:url value="/template/Trung/assets/js/pages/ecommerce-product-list.init.js"/>"></script>
...
<script src="<c:url value="/template/Trung/assets/libs/prismjs/prism.js"/>"></script>
...
<!-- Mirrored from themesbrand.com/velzon/html/default/apps-ecommerce-products.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 04 Dec 2022 12:41:37 GMT -->
